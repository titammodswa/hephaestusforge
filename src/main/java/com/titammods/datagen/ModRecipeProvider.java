...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput output) {
        ...
        registerExternalMetal(atoOutput, HephaestusFluids.SETS.get(HephaestusFluids.Material.MOLTEN_IRIDIUM).source.get(), 2440, "iridium", "alltheores", "alltheores_compat/");
        ...
        registerExternalMetal(atoOutput, HephaestusFluids.SETS.get(HephaestusFluids.Material.MOLTEN_OSMIUM).source.get(), 3000, "osmium", "alltheores", "alltheores_compat/");
        ...
        registerExternalMetal(ftbOutput, HephaestusFluids.SETS.get(HephaestusFluids.Material.MOLTEN_OSMIUM).source.get(), 3000, "osmium", "ftbmaterials", "ftbmaterials_compat/");
