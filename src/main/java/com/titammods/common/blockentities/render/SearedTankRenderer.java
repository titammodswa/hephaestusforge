...
public class SearedTankRenderer implements BlockEntityRenderer<SearedTankBlockEntity, SearedTankRenderState> {

    @SuppressWarnings("unused")
    public SearedTankRenderer(BlockEntityRendererProvider.Context ctx) {}
    ...
    public void extractRenderState(SearedTankBlockEntity blockEntity,
        ...
        state.fluid    = blockEntity.getFluidTank().getFluid().copy();
        state.capacity = blockEntity.getFluidTank().getCapacity();
    }

    @Override
    public void submit(SearedTankRenderState state, PoseStack poseStack,
