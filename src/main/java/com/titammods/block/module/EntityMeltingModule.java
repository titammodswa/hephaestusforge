package com.titammods.block.module;
...
public class EntityMeltingModule {
    ...
    private @Nullable ModRecipes.EntityMeltingRecipe findRecipe(EntityType<?> type) {
        ...
        for (var holder : sl.getServer().getRecipeManager()
                .getAllRecipesFor(ModRecipes.ENTITY_MELTING_TYPE.get())) {
        ...
        for (Entity entity : level.getEntitiesOfClass(Entity.class, innerBounds)) {
            ...
            if (entity instanceof LivingEntity living) {
                ...
                if (recipe != null) {
                    ...
                    fluid  = new FluidStack(com.titammods.registry.HephaestusFluids.SETS.get(com.titammods.registry.HephaestusFluids.Material.LIQUID_MEAT).source.get(), 50);
                    damage = 2;
                }
