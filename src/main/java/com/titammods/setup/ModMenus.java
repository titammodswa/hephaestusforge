...
public class ModMenus {
    ...
    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(BuiltInRegistries.MENU, TitamMods.MODID);

    public static final Supplier<MenuType<MelterMenu>> MELTER_MENU =
    ...
    public static final Supplier<MenuType<com.titammods.menu.SmelteryMenu>> SMELTERY_MENU =
            MENUS.register("smeltery_menu", () -> IMenuTypeExtension.create(com.titammods.menu.SmelteryMenu::new));
}
