...
public class MelterCategory implements IRecipeCategory<ModRecipes.MeltingRecipe> {
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(TitamMods.MODID, "textures/gui/jei/melting.png");
    ...
    @Override
    public void draw(ModRecipes.MeltingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics graphics, double mouseX, double mouseY) {
        ...
        int x = 68 - fontRenderer.width(tempString) / 2;
